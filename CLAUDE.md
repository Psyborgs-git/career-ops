...
- **Automated Applications:** When specifically requested by the user, the model can use Playwright to fill and submit application forms on their behalf. Otherwise, it should stop before clicking Submit for final review.
