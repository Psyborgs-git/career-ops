...
const CANONICAL_REPO = 'https://github.com/Psyborgs-git/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/Psyborgs-git/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/Psyborgs-git/career-ops/releases/latest';
